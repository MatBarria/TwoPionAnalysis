    ...
    for i in range(6): # Loops on the diffrent targets
        for j in range(nPion): # Loops on the number of pions
            for k in range(NZh): # Loops on Zh bins
                ...
                graphName = ["Pt2_Distribution_" + tarList[i] + "_" + str(k) + "_" + str(j+1),
                            "Pt2_Distribution_Clean_" + tarList[i] + "_" + str(k) + "_" + str(j+1),
                            "Pt2_Distribution_Inter_" + tarList[i] + "_" + str(k) + "_" + str(j+1)]
                order = [0, 2, 1]
                for n in order: 
