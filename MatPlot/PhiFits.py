...
def PhiFittedFunction(target, NPion, Q2, Xb, Zh, Pt, PhiBins):
    ...
    histName  = "PhiDist Q2=" + str(Q2) + " Nu=" + str(Xb) + " Zh=" + str(Zh) + " Pt2=" + str(Pt)
    ...
    fig.savefig(outputDirectory + "PhiFitFunc_" + str(NPion) + "_" + str(PhiBins) + ".pdf" )
    print(outputDirectory + "PhiFitFunc_" + str(NPion) + "_" + str(PhiBins) + ".pdf" )
    fileHist.Close()


PhiFittedFunction('Fe', 1, 1, 2, 5, 25, 6)
PhiFittedFunction('Fe', 1, 1, 2, 5, 25, 12)
PhiFittedFunction('Fe', 2, 1, 2, 5, 21, 6)
PhiFittedFunction('Fe', 2, 1, 2, 5, 21, 12)
