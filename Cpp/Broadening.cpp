// This code calculate and plot the Pt broadening using the histograms generated by
// Integration.cpp It can be compile with g++ -Wall -fPIC -I../include `root-config --cflags`
// Broadening.cpp -o ../bin/Broadening  `root-config --glibs` ../include/Broad.h
