...
// g++ -Wall -fPIC  `root-config --cflags` VecSumSimulDeltaZ.cpp -o ./bin/VecSumSimulDeltaZ  `root-config --glibs`
...
int main(int argc, char* argv[]) {
  ...
  // Save the Ntuple
  //TFile *fileOutput= new TFile(Form("/eos/user/m/mbarrial/Data/Acc/SimulTuple_%sdeltaZ.root", targetArr), "RECREATE");
