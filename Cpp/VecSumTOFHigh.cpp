...
int main(int argc, char* argv[]) {
    ...
    TFile* file = new TFile(Form(dataDirectory + "%s_data_Npion_TOF_Pl29.root", targetArr), "READ");
    ...
    // Save the tuples
    TFile* fOutput = new TFile(Form(dataDirectory + "VecSum_%sTOFHigh.root", targetArr), "RECREATE");
    fOutput->cd();
